...
// Parkleitsystem SDK idempotency feature
...
class ParkleitsystemIdempotencyFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _mutating(ParkleitsystemContext $ctx): bool
    {
