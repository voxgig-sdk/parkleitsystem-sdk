...
// Parkleitsystem SDK audit feature
...
class ParkleitsystemAuditFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _emit(ParkleitsystemContext $ctx, string $outcome): void
    {
