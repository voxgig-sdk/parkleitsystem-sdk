...
// Parkleitsystem SDK rbac feature
...
class ParkleitsystemRbacFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _required(ParkleitsystemContext $ctx): ?string
    {
    ...
    private function _reject(ParkleitsystemContext $ctx, string $required): void
    {
    ...
    private function _track(ParkleitsystemContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
