...
// Parkleitsystem SDK metrics feature
...
class ParkleitsystemMetricsFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _record(ParkleitsystemContext $ctx, bool $ok): void
    {
