...
// Parkleitsystem SDK proxy feature
...
class ParkleitsystemProxyFeature extends ParkleitsystemBaseFeature
{
    ...
    public function init(ParkleitsystemContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ParkleitsystemContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
