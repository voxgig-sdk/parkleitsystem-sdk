...
class ParkleitsystemFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ParkleitsystemSDK/1.0)';
    ...
    public static function call(ParkleitsystemContext $ctx, string $fullurl, array $fetchdef): array
    {
