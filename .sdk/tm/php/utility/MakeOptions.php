...
// Parkleitsystem SDK utility: make_options

class ParkleitsystemMakeOptions
{
    ...
    public static function call(ParkleitsystemContext $ctx): array
    {
        ...
        //
        // `ParkleitsystemSchema::optspec()` is built from the model:
        ...
        $optspec = ParkleitsystemSchema::optspec();
