...
|---|---|---|
| `ts/` | @voxgig-sdk/parkleitsystem-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/parkleitsystem-sdk \
      --repository voxgig-sdk/parkleitsystem-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/parkleitsystem-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/parkleitsystem-sdk --id=<id>` removes one.
