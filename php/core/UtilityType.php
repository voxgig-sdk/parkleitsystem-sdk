...
// Parkleitsystem SDK utility type

class ParkleitsystemUtility
{
    ...
    public static function copy(ParkleitsystemUtility $src): ParkleitsystemUtility
    {
        $u = new ParkleitsystemUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
