...
The PHP SDK for the Parkleitsystem API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetAllCity(null)->list(null, null);
...
[$result, $err] = $client->Parkleitsystem(null)->load(
    ["id" => "test01"], null
);
