...
// Parkleitsystem SDK GetCityParkingInfo entity
...
class GetCityParkingInfoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "get_city_parking_info";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GetCityParkingInfoEntity($this->_client, $opts);
    }

    /**
     * @param GetCityParkingInfo|array $args GetCityParkingInfo data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = ParkleitsystemHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return GetCityParkingInfo|array The current GetCityParkingInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetCityParkingInfo fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = ParkleitsystemHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of GetCityParkingInfo fields).
     */
    ...
    /**
     * List GetCityParkingInfo items matching the given filter.
     *
     * @param GetCityParkingInfoListMatch|array|null $reqmatch Match filter (any subset
     *   of GetCityParkingInfo fields) as an assoc-array; GetCityParkingInfoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetCityParkingInfo[]|array A list of GetCityParkingInfo items as assoc-arrays at
     *   the SDK boundary; throws ParkleitsystemError on failure (item-5 convention).
     */
