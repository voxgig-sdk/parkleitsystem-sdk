...
class ParkleitsystemSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ParkleitsystemHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ParkleitsystemHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ParkleitsystemFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ParkleitsystemFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ParkleitsystemUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ParkleitsystemHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ParkleitsystemHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ParkleitsystemHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ParkleitsystemError($op . "_allow",
                "ParkleitsystemSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ParkleitsystemHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ParkleitsystemError("graphql_error",
                "ParkleitsystemSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetAllCity($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_all_city === null) {
                $this->_get_all_city = new GetAllCityEntity($this, null);
            }
            return $this->_get_all_city;
        }
        return new GetAllCityEntity($this, $data);
    }
    ...
    public function GetCityParkingInfo($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_city_parking_info === null) {
                $this->_get_city_parking_info = new GetCityParkingInfoEntity($this, null);
            }
            return $this->_get_city_parking_info;
        }
        return new GetCityParkingInfoEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ParkleitsystemSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
