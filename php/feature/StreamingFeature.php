...
// Parkleitsystem SDK streaming feature
...
class ParkleitsystemStreamingFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _iterate(ParkleitsystemResult $result): \Generator
    {
    ...
    private function _streamable(ParkleitsystemContext $ctx): bool
    {
