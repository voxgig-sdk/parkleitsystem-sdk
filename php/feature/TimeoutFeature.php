...
// Parkleitsystem SDK timeout feature
...
class ParkleitsystemTimeoutFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _with_timeout(ParkleitsystemContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ParkleitsystemContext $_ctx, float $ms): void
    {
        $client = $this->client;
