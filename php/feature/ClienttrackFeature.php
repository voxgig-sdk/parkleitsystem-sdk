...
// Parkleitsystem SDK clienttrack feature
...
class ParkleitsystemClienttrackFeature extends ParkleitsystemBaseFeature
{
    ...
    public function PostConstruct(ParkleitsystemContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Parkleitsystem-SDK';
