...
// Parkleitsystem SDK ratelimit feature
...
class ParkleitsystemRatelimitFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _acquire(ParkleitsystemContext $ctx): void
    {
    ...
    private function _track(ParkleitsystemContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
