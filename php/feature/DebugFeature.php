...
// Parkleitsystem SDK debug feature
...
class ParkleitsystemDebugFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _finish(ParkleitsystemContext $ctx, bool $ok): void
    {
