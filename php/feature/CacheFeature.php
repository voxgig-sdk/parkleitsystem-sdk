...
// Parkleitsystem SDK cache feature
...
class ParkleitsystemCacheFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _through(ParkleitsystemContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
