...
// Parkleitsystem SDK netsim feature
...
class ParkleitsystemNetsimFeature extends ParkleitsystemBaseFeature
{
    ...
    private function _simulate(ParkleitsystemContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ParkleitsystemContext $ctx, array $applied): void
    {
        $client = $this->client;
