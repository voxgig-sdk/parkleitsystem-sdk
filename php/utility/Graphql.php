...
// Parkleitsystem SDK utility: graphql
//
...
class ParkleitsystemGraphql
{
    ...
    // equivalent.
    public static function body(ParkleitsystemContext $ctx): mixed
    {
    ...
    public static function errors(ParkleitsystemContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
