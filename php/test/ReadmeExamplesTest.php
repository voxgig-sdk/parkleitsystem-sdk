...
// Parkleitsystem SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ParkleitsystemSDK::test)
...
{
    private const SDK_CLASS = 'ParkleitsystemSDK';
    ...
    private const SDK_BASE = 'parkleitsystem_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../parkleitsystem_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
