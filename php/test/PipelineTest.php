...
// Parkleitsystem SDK pipeline test
//
...
{
    private static function utility(): ParkleitsystemUtility
    {
        return new ParkleitsystemUtility();
    }
    ...
    private static function ctx(array $over = []): ParkleitsystemContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ParkleitsystemContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ParkleitsystemOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ParkleitsystemError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ParkleitsystemOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ParkleitsystemMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ParkleitsystemOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ParkleitsystemMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ParkleitsystemOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ParkleitsystemMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ParkleitsystemSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ParkleitsystemMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ParkleitsystemResponse([]),
            'result' => new ParkleitsystemResult([]),
        ]);
        [, $err] = ParkleitsystemMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ParkleitsystemSpec([]),
            'response' => null,
            'result' => new ParkleitsystemResult([]),
        ]);
        [, $err] = ParkleitsystemMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ParkleitsystemSpec(['step' => 's']),
            'response' => new ParkleitsystemResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ParkleitsystemResult([]),
        ]);
        [, $err] = ParkleitsystemMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ParkleitsystemSpec(['step' => 's']),
            'response' => new ParkleitsystemResponse(self::resp(200, ['v' => 1])),
            'result' => new ParkleitsystemResult([]),
        ]);
        [, $err] = ParkleitsystemMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ParkleitsystemSpec(['step' => 's']),
            'response' => new ParkleitsystemResponse(self::resp(200, ['v' => 2])),
            'result' => new ParkleitsystemResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ParkleitsystemMakeResponse::call($ctx);
    ...
    {
        $preset = new ParkleitsystemResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ParkleitsystemSpec([]),
            'response' => new ParkleitsystemResponse([]),
            'result' => new ParkleitsystemResult([]),
        ...
        [$got, $err] = ParkleitsystemMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ParkleitsystemResult([])]);
        [, $err] = ParkleitsystemMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ParkleitsystemSpec([]), 'result' => null]);
        [, $err] = ParkleitsystemMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ParkleitsystemSpec(['step' => 's']),
            'result' => new ParkleitsystemResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ParkleitsystemOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ParkleitsystemMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ParkleitsystemSpec(['step' => 's']),
            'result' => new ParkleitsystemResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ParkleitsystemOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ParkleitsystemMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ParkleitsystemResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ParkleitsystemSpec([]),
            'result' => new ParkleitsystemResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ParkleitsystemMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ParkleitsystemMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ParkleitsystemError('boom', 'boom');
        $utility->fetcher = function (ParkleitsystemContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ParkleitsystemSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ParkleitsystemMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ParkleitsystemContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ParkleitsystemMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ParkleitsystemResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ParkleitsystemMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ParkleitsystemContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ParkleitsystemSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ParkleitsystemMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ParkleitsystemResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ParkleitsystemSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ParkleitsystemMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ParkleitsystemMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ParkleitsystemMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ParkleitsystemResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ParkleitsystemDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ParkleitsystemResult(['ok' => false])]);
        $this->expectException(ParkleitsystemError::class);
        ParkleitsystemDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ParkleitsystemResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ParkleitsystemMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ParkleitsystemMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ParkleitsystemBaseFeature();
        $b = new ParkleitsystemBaseFeature();
        ParkleitsystemFeatureAdd::call($ctx, $a);
        ParkleitsystemFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ParkleitsystemBaseFeature
    {
        $f = new ParkleitsystemBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ParkleitsystemFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?ParkleitsystemSpec $spec): ParkleitsystemContext
    {
    ...
    private static function auth_bags(): ParkleitsystemSpec
    {
        return new ParkleitsystemSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        ParkleitsystemPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ParkleitsystemPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ParkleitsystemResponse(['headers' => null]),
            'result' => new ParkleitsystemResult([]),
        ]);
        ParkleitsystemResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ParkleitsystemResultBody::call($ctx);
