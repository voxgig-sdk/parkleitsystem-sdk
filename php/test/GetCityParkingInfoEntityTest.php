...
class GetCityParkingInfoEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = ParkleitsystemSDK::test($seed, null);
        $seen = iterator_to_array($base->GetCityParkingInfo(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->GetCityParkingInfo(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        $get_city_parking_info_ref01_list_result = $get_city_parking_info_ref01_ent->list($get_city_parking_info_ref01_match, null);
