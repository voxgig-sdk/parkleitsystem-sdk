...
// Parkleitsystem SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ParkleitsystemOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ParkleitsystemOmni::structfix($now, Struct::undef()))
                        !== json_encode(ParkleitsystemOmni::structfix($val, Struct::undef()))) {
