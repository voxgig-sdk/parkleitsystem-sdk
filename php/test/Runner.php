...
class ParkleitsystemTestRunner
{
    ...
    {
        $live = self::getenv('PARKLEITSYSTEM_TEST_LIVE');
        $override = self::getenv('PARKLEITSYSTEM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PARKLEITSYSTEM_TEST_EXPLAIN');
...
class_alias('ParkleitsystemTestRunner', 'Runner');
class_alias('ParkleitsystemHelpers', 'Helpers');
