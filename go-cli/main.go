// Command Parkleitsystem-cli is a CLI + REPL for the Parkleitsystem SDK,
...
const prompt = "parkleitsystem"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "get_all_city get_city_parking_info"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      PARKLEITSYSTEM_APIKEY (api key), PARKLEITSYSTEM_BASE (base url override)")
