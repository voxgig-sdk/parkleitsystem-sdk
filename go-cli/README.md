...
AQL-driven CLI and REPL for the Parkleitsystem SDK. Positional arguments are
...
./parkleitsystem-cli load 1 get_all_city
./parkleitsystem-cli load '{id:1}' get_all_city
