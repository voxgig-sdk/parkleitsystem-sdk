...
func registerSDKWords(r *eng.Registry, client *sdk.ParkleitsystemSDK) {
...
func runOp(client *sdk.ParkleitsystemSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
