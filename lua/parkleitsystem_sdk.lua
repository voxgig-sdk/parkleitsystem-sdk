...
local ParkleitsystemSDK = {}
ParkleitsystemSDK.__index = ParkleitsystemSDK
...
ParkleitsystemSDK._make_feature = _make_feature


function ParkleitsystemSDK.new(options)
  local self = setmetatable({}, ParkleitsystemSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ParkleitsystemSDK:options_map()
...
function ParkleitsystemSDK:get_utility()
  return Utility.copy(self._utility)
end


function ParkleitsystemSDK:get_root_ctx()
  return self._rootctx
end


function ParkleitsystemSDK:prepare(fetchargs)
...
function ParkleitsystemSDK:direct(fetchargs)
...
-- by passing it.
function ParkleitsystemSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ParkleitsystemSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ParkleitsystemSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function ParkleitsystemSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ParkleitsystemSDK.new(sdkopts)
  sdk.mode = "test"
