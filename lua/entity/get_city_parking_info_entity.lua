...
local GetCityParkingInfoEntity = {}
GetCityParkingInfoEntity.__index = GetCityParkingInfoEntity


function GetCityParkingInfoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetCityParkingInfoEntity)
  self._name = "get_city_parking_info"
  self._client = client
...
function GetCityParkingInfoEntity:get_name()
  return self._name
end


function GetCityParkingInfoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetCityParkingInfoEntity.new(self._client, opts)
end
...
function GetCityParkingInfoEntity:mark_deleted()
  self._deleted = true
end


function GetCityParkingInfoEntity:deleted()
  return true == self._deleted
end


function GetCityParkingInfoEntity:data_set(args)
  if args ~= nil then
...
function GetCityParkingInfoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetCityParkingInfoEntity:match_set(args)
  if args ~= nil then
...
function GetCityParkingInfoEntity:match_get()
...
function GetCityParkingInfoEntity:stream(action, args, callopts)
...
function GetCityParkingInfoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetCityParkingInfoEntity
