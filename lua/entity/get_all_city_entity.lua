...
local GetAllCityEntity = {}
GetAllCityEntity.__index = GetAllCityEntity


function GetAllCityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetAllCityEntity)
  self._name = "get_all_city"
  self._client = client
...
function GetAllCityEntity:get_name()
  return self._name
end


function GetAllCityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetAllCityEntity.new(self._client, opts)
end
...
function GetAllCityEntity:mark_deleted()
  self._deleted = true
end


function GetAllCityEntity:deleted()
  return true == self._deleted
end


function GetAllCityEntity:data_set(args)
  if args ~= nil then
...
function GetAllCityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetAllCityEntity:match_set(args)
  if args ~= nil then
...
function GetAllCityEntity:match_get()
...
function GetAllCityEntity:stream(action, args, callopts)
...
function GetAllCityEntity:_run_op(ctx, post_done)
  local utility = self._utility
