...
function runner.env_override(m)
  local live = runner.getenv("PARKLEITSYSTEM_TEST_LIVE")
  local override = runner.getenv("PARKLEITSYSTEM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PARKLEITSYSTEM_TEST_EXPLAIN")
