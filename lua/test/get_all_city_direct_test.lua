...
describe("GetAllCityDirect", function()
  it("should direct-list-get_all_city", function()
    local setup = get_all_city_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_all_city", setup.live and "live" or "unit")
...
function get_all_city_direct_setup(mockres)
