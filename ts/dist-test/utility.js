...
function envOverride(m) {
    if ('TRUE' === process.env.PARKLEITSYSTEM_TEST_LIVE ||
        'TRUE' === process.env.PARKLEITSYSTEM_TEST_OVERRIDE) {
    ...
    m.PARKLEITSYSTEM_TEST_EXPLAIN = process.env.PARKLEITSYSTEM_TEST_EXPLAIN || m.PARKLEITSYSTEM_TEST_EXPLAIN;
    return m;
}
