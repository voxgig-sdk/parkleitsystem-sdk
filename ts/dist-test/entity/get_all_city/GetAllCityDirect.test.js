...
(0, node_test_1.describe)('GetAllCityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-get_all_city', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_all_city', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PARKLEITSYSTEM_TEST_GET_ALL_CITY_ENTID'];
...
//# sourceMappingURL=GetAllCityDirect.test.js.map