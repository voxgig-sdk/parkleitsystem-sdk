...
function basicSetup(extra) {
    ...
    let idmap = transform(['get_city_parking_info01', 'get_city_parking_info02', 'get_city_parking_info03', 'city01'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
