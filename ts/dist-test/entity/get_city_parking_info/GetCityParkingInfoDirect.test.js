...
(0, node_test_1.describe)('GetCityParkingInfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ParkleitsystemSDK({
    ...
    (0, node_test_1.test)('direct-list-get_city_parking_info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_city_parking_info', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["get_city_parking_info01"]))
            return;
...
function liveScenariosActive() { return false && process.env.PARKLEITSYSTEM_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ParkleitsystemSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PARKLEITSYSTEM_TEST_GET_CITY_PARKING_INFO_ENTID'];
    ...
    const client = new __1.ParkleitsystemSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetCityParkingInfoDirect.test.js.map