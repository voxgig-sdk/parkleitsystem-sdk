...
class GetCityParkingInfoEntity extends ParkleitsystemEntityBase_1.ParkleitsystemEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'get_city_parking_info';
        this.name_ = 'get_city_parking_info';
        this.Name = 'GetCityParkingInfo';
    }
    make() {
        return new GetCityParkingInfoEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<GetCityParkingInfo[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.GetCityParkingInfoEntity = GetCityParkingInfoEntity;
//# sourceMappingURL=GetCityParkingInfoEntity.js.map