// Command Parkleitsystem-mcp is an MCP server exposing the Parkleitsystem
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Parkleitsystem_list  — list records of an entity
//	Parkleitsystem_load  — load a single record of an entity
//
