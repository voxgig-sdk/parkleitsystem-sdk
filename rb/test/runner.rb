...
module ParkleitsystemTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("PARKLEITSYSTEM_TEST_LIVE")
    override = getenv("PARKLEITSYSTEM_TEST_OVERRIDE")
    ...
    explain = getenv("PARKLEITSYSTEM_TEST_EXPLAIN")
    m["PARKLEITSYSTEM_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ParkleitsystemTestRunner
Helpers = ParkleitsystemHelpers
Vs = VoxgigStruct
