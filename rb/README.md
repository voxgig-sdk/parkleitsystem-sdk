...
The Ruby SDK for the Parkleitsystem API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.Parkleitsystem(nil).load(
  { "id" => "test01" }, nil
)
