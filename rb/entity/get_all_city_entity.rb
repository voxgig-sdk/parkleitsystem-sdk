...
class GetAllCityEntity
  ...
  def make
    opts = @_entopts.dup
    GetAllCityEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [GetAllCityListMatch, Hash, nil] match filter (any subset of
  #   GetAllCity fields); defaults to nil, treated as an empty match that lists all.
