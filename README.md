...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/parkleitsystem` | `npm install @voxgig-sdk/parkleitsystem` |
| Python | `voxgig-sdk-parkleitsystem` | `pip install voxgig-sdk-parkleitsystem` |
| PHP | `voxgig-sdk/parkleitsystem` | `composer require voxgig-sdk/parkleitsystem` |
| Golang | `github.com/voxgig-sdk/parkleitsystem-sdk/go` | `go get github.com/voxgig-sdk/parkleitsystem-sdk/go` |
| Ruby | `voxgig-sdk-parkleitsystem` | `gem install voxgig-sdk-parkleitsystem` |
| Lua | `voxgig-sdk-parkleitsystem` | `luarocks install voxgig-sdk-parkleitsystem` |
