...
from parkleitsystem_sdk.core.helpers import get_ctx_prop, to_map
...
class ParkleitsystemContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ParkleitsystemControl()
        ...
        if isinstance(sp, ParkleitsystemSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ParkleitsystemResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ParkleitsystemResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ParkleitsystemOperation({})
    ...
    def make_error(self, code, msg):
        return ParkleitsystemError(code, msg, self)
