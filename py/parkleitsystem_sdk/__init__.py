...
from parkleitsystem_sdk.utility import register

# Load features
from parkleitsystem_sdk.feature.base_feature import ParkleitsystemBaseFeature
from parkleitsystem_sdk.features import _has_feature, _make_feature
...
class ParkleitsystemSDK:
    ...
    def get_utility(self):
        return ParkleitsystemUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ParkleitsystemSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetAllCity(self, data=None) -> "GetAllCityEntity":
        ...
        from parkleitsystem_sdk.entity.get_all_city_entity import GetAllCityEntity
    ...
    def GetCityParkingInfo(self, data=None) -> "GetCityParkingInfoEntity":
        ...
        from parkleitsystem_sdk.entity.get_city_parking_info_entity import GetCityParkingInfoEntity
