# Parkleitsystem SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ParkleitsystemSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ParkleitsystemSDK(...) and ParkleitsystemSDK.test(...) become
#      ParkleitsystemSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "parkleitsystem_sdk"
_SDK_CLASS = "ParkleitsystemSDK"
...
_ENTITIES = {
    "GetAllCity": "get_all_city",
    "GetCityParkingInfo": "get_city_parking_info",
}
