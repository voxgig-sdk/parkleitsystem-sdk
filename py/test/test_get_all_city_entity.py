...
class TestGetAllCityEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.GetAllCity(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.GetAllCity(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        get_all_city_ref01_list_result = get_all_city_ref01_ent.list(get_all_city_ref01_match, None)
