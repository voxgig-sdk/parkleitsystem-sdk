...
const testSeed = `map[string]any{"entity": map[string]any{"get_all_city": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_city_parking_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
