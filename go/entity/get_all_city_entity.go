...
func NewGetAllCityEntity(client *core.ParkleitsystemSDK, entopts map[string]any) *GetAllCityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetAllCityEntity) GetName() string { return e.name }
...
func (e *GetAllCityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetAllCityEntity) Deleted() bool {
	return e.deleted
}


func (e *GetAllCityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetAllCityEntity(e.client, opts)
}

func (e *GetAllCityEntity) Data(args ...any) any {
...
func (e *GetAllCityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetAllCityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetAllCityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GetAllCityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetAllCityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetAllCityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetAllCityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
