...
type GetCityParkingInfoEntity struct {
	name    string
	client  *core.ParkleitsystemSDK
...
func NewGetCityParkingInfoEntity(client *core.ParkleitsystemSDK, entopts map[string]any) *GetCityParkingInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetCityParkingInfoEntity) GetName() string { return e.name }
...
func (e *GetCityParkingInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetCityParkingInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *GetCityParkingInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetCityParkingInfoEntity(e.client, opts)
}

func (e *GetCityParkingInfoEntity) Data(args ...any) any {
...
func (e *GetCityParkingInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetCityParkingInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetCityParkingInfoEntity) DataTyped(data ...GetCityParkingInfo) GetCityParkingInfo {
	if len(data) > 0 {
		return typedFrom[GetCityParkingInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[GetCityParkingInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetCityParkingInfo (all fields
// optional at the wire level).
func (e *GetCityParkingInfoEntity) MatchTyped(match ...GetCityParkingInfo) GetCityParkingInfo {
	if len(match) > 0 {
		return typedFrom[GetCityParkingInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[GetCityParkingInfo](e.Match())
}
...
func (e *GetCityParkingInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetCityParkingInfoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetCityParkingInfoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetCityParkingInfoListMatch and returns []GetCityParkingInfo. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetCityParkingInfoEntity) ListTyped(reqmatch GetCityParkingInfoListMatch, ctrl map[string]any) ([]GetCityParkingInfo, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetCityParkingInfo](res), nil
}



func (e *GetCityParkingInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetCityParkingInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetCityParkingInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetCityParkingInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
