...
// instead of `sdk.NewParkleitsystemSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ParkleitsystemSDK  { return NewParkleitsystemSDK(nil) }
func Test() *ParkleitsystemSDK { return TestSDK(nil, nil) }
