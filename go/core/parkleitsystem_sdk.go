...
func (sdk *ParkleitsystemSDK) OptionsMap() map[string]any {
...
func (sdk *ParkleitsystemSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ParkleitsystemSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ParkleitsystemSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ParkleitsystemSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ParkleitsystemSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ParkleitsystemSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ParkleitsystemSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ParkleitsystemSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ParkleitsystemSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ParkleitsystemSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ParkleitsystemSDK {
	...
	sdk := NewParkleitsystemSDK(sdkopts)
	sdk.Mode = "test"
